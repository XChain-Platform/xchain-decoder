...
const { logger, CHECK_BLOCK_DELAY_MS, BLOCKCHAIN_INFO_REFRESH_MS, MEMPOOL_INTERVAL, REORG_HALT_PARK_TICK_MS, MAGIC_WORD, MAGIC_WORD_BUFFER, P2SH_BUFFER, P2WSH_BUFFER, FUNDING_VOUT_BASE, SYNCED_THRESHOLD, DISPENSER_EXPIRE_SAFE_DEPTH, MIN_VERIFICATION_PROGRESS_TO_PARSE, VALID_ACTION_NAMES, DB_TRANSACTION_BLOCKS_QUANTITY, LOG_BLOCK_INTERVAL, TX_PARSE_MAX_RETRIES, AUXPOW_REASSEMBLE_AFTER } = require('./XChainDecoder/constants.js')
