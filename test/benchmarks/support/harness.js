 ...
 *
 * Usage:
 *   node test/benchmarks/support/harness.js                    # run all scenarios
 *   node test/benchmarks/support/harness.js --scenario NAME    # run one scenario
 *   node test/benchmarks/support/harness.js --list             # list available scenarios
 *   node test/benchmarks/support/harness.js --compare          # compare against baseline
 *   node test/benchmarks/support/harness.js --save-baseline    # save results as new baseline
 *   node test/benchmarks/support/harness.js --json             # output raw JSON
...
const MockBlockchainConnector = require('./mock_blockchain_connector')
...
Usage: node test/benchmarks/support/harness.js [options]
